...
COMMANDS = (
    ...
    "• `.سؤال [نص]` : محادثة ذكية فورية\n"
    "• `.كود [لغة] [وصف]` : برمجة وتصحيح ذكي\n"
    "• `.رسم [وصف]` : إنشاء وصف للصور\n"
    "• `.مقال [موضوع]` : كتابة محتوى طويل\n"
    ...
    "• `.تصميم [وصف]` : تصميمات جرافيك\n"
    "• `.خطط [هدف]` : تخطيط استراتيجي\n"
    "• `.اختبر [موضوع]` : اختبار معرفي\n"
    "• `.حكمة` : حكمة اليوم الذكية\n"
    "• `.تطوير` : معلومات التطوير\n"
    "• `.صور` : إنشاء صور بالذكاء الاصطناعي"
)
